...
\part [15]  For each iteration, provide all nodes currently in $S$ (at the beginning of the iteration), all edges in the cut-set $C_{S, \bar{S}}$, and the edge that should be added to the minimum spanning tree $T$.  Start at vertex A.  Break any ties alphabetically. \medskip
